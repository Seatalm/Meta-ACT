...
class blocks_ranking_rgb(Base_Task):
    ...
    def play_once(self):
        ...
        # Only perform the first two block placement subtasks
        ...
        # Keep the object generation unchanged, but no need to move the third block for this subtask
        arm_tag3 = str(ArmTag("left" if self.block3.get_pose().p[0] < 0 else "right"))
    ...
    def check_success(self):
        ...
        # Only require the first two blocks to be ordered correctly.
